...
function AllStocksPage() {
    ...
    return (
        ...
        <Sort setSortedStocks={setSortedStocks} sortBy={sortBy} sortCheck={sortCheck} stocks={stocks} />
  ...
  {stocks ?  <TagStockTableBody stocks={sortedStocks ? sortedStocks : stocks.filter(s => s.symbol !== 'DASH')}/> : <p>Loading..</p> }
